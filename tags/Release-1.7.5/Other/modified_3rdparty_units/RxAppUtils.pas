...
{$IFDEF WIN32}
      ...
      begin
        ...
        // [MJ] REMOVED the following line, because we handle minimizing
        // ourselves within each application. We want FormPlacement to only
        // restore "normal" or "maximized" form state, but NOT to minimize
