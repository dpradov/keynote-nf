...
type
  TForm_Main = class(TForm)
    ...
    procedure RxRTFURLClick(Sender: TObject; const URLText: String;
      Button: TMouseButton);
...
procedure TForm_Main.InsertFileOrLink( const aFileName : string; const AsLink : boolean );
var
  fn : string;
  oldFilter : string;
  ImportFileType : TImportFileType;
  ext : string;
  //Form_RTF : TForm_tmpRTF;            //*1  (002)
  RTFAux: TRxRichEdit;                  //*1 (002)
...
function TForm_Main.BuildKNTLocationText( const aLocation : TLocation ) : string;
var
...
procedure TForm_Main.InsertOrMarkKNTLink( aLocation : TLocation; const AsInsert : boolean );
begin
  if ( not HaveNotes( true, true )) then exit;
  if ( not assigned( ActiveNote )) then exit;
  ...
  begin
    ...
    ActiveNote.Editor.SelLength := 0;
    StatusBar.Panels[PANEL_HINT].Text := ' Location inserted';
  ...
  begin
    ...
    StatusBar.Panels[PANEL_HINT].Text := ' Current location marked';
...
procedure TForm_Main.JumpToKNTLocation( LocationStr : string );
type
    ...
    try
      ...
      *)
      ...
      begin
        ...
        begin
          StatusBar.Panels[PANEL_HINT].Text := ' Failed to open location';
      ...
      on E : Exception do
      begin
        StatusBar.Panels[PANEL_HINT].Text := ' Invalid location';
...
procedure TForm_Main.RxRTFURLClick(Sender: TObject; const URLText: String;
  Button: TMouseButton);
var
  ...
  try
    try
      ...
      begin
        ...
        begin
          StatusBar.Panels[PANEL_HINT].Text := ' Hold down SHIFT while clicking the URL.';
          exit;
        end;
      end;
      ...
      begin
        Form_URLAction := TForm_URLAction.Create( self );
        try
      ...
      begin
        StatusBar.Panels[PANEL_HINT].Text := ' URL action canceled';
        exit;
      end;
      ...
      begin
        ...
        StatusBar.Panels[PANEL_HINT].Text := ' URL copied to clipboard';
      end;
        ...
        case URLType of
          urlFILE : begin // it may be a KNT location or a normal file URL.
            ...
            begin
              ...
              postmessage( Handle, WM_JumpToKNTLink, 0, 0 );
              exit;
            end
            else
            begin
