...
{
 The component must be installed in Delphi IDE with "CustomCreateWindowHandle(Self, Params)" commented.
 Code of KeyNote-NF will be statically linked with RxRichEd.pas, in wich that line is not commented.
