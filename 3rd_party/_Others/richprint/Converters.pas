...
function ImportAsRTF(FileName: String; Converter: String; rtbApp: TOLEEdit): Boolean;

// Function to export RTF to a file.
function ExportRTF(FileName: String; Converter: String; rtbApp: TOLEEdit): Boolean;
...
function LoadConverter(Description: string; Import: boolean): HWND;
...
begin
  ...
  try
    if LoadConverter(Converter, True) <> 0 then
      begin
